...
GLfloat white_light_second[] =  {0.69, 1.0, 1.0, 1.0 };
GLfloat light_position0[] = { 5.0, 1.0, 1.0, 0.0 };
GLfloat light_position1[] = { -10.0, 1.0, -5.0, 0.0 };
GLfloat light_position2[] = { 1.0, -10.0, 1.0, 0.0 };
GLfloat matSpecular[] =     { 1.0, 1.0, 1.0, 1.0 };
GLfloat matShininess[] =    { 69.0 };
...
void initialise(void) {
   TexBits = LoadDIBitmap("cluster.bmp", &TexInfo);

   glLightfv(GL_LIGHT0, GL_POSITION, light_position0);
   glLightfv(GL_LIGHT0, GL_DIFFUSE, white_light);

   glLightfv(GL_LIGHT1, GL_POSITION, light_position1);
   glLightfv(GL_LIGHT1, GL_SPECULAR, white_light_second);
 
   glLightfv(GL_LIGHT2, GL_POSITION, light_position2);
   glLightfv(GL_LIGHT2, GL_SPECULAR, white_light_second);
...
void display(void) {  
   glClearColor(69.0/255.0, 69.0/255.0, 70.0/255.0, 0.1);
...
void keyboard(unsigned char key, int x, int y) {
   switch(key) {
    ...
    case 'S':
      shadeMode = !shadeMode;
      if(shadeMode == 0) glShadeModel(GL_SMOOTH);
